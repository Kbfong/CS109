...
class inode_state {
   ...
   public:
      ...
      void setPrompt(string input) { this->prompt_ = input; }
...
class inode {
   ...
   public:
      ...
      void setParent(inode_ptr input){
        parent=input;
      }
      inode_ptr getParent(){
        return parent;
...
class base_file {
   ...
   public:
      ...
      virtual void insertDirent(inode_ptr, string) = 0;
      virtual inode_ptr findDirent(string) = 0;
      virtual void setDir(inode_ptr, inode_ptr) = 0;
      virtual void dirInit(inode_ptr) = 0;
      virtual void printFile() = 0;
     // virtual map<string, inode_ptr>& getDirents() = 0;
      virtual void printDirents(inode_ptr, string) = 0;
      virtual string& getFileType() = 0;
   // virtual void removeAll() = 0;
   // virtual void printAllDirents(inode_ptr, string) = 0;
};
...
class plain_file: public base_file {
   ...
   public:
      ...
      virtual void insertDirent(inode_ptr, string) override;
      virtual inode_ptr findDirent(string) override;
      virtual void dirInit (inode_ptr) override;
      virtual void setDir (inode_ptr, inode_ptr) override;
    //  virtual map<string, inode_ptr>& getDirents() override;
      virtual void printFile() override;
      virtual void printDirents(inode_ptr, string) override;
      virtual string& getFileType(){ return fileType;}
     //virtual void removeAll() override;
      //virtual void printAllDirents(inode_ptr, string) override;
};
...
class directory: public base_file {
   ...
   public:
      ...
      virtual void insertDirent(inode_ptr, string) override;
      virtual inode_ptr findDirent(string) override;
      virtual void dirInit(inode_ptr) override; //setDefaultDir
      virtual void setDir(inode_ptr, inode_ptr) override; //setDirect
     // virtual map<string, inode_ptr>& getDirents() override;
      virtual void printFile() override;
      virtual void printDirents(inode_ptr, string) override;
      virtual string& getFileType(){ return fileType;}
